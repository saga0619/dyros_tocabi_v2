...
namespace Eigen
{
  ...
  typedef Matrix<double, 1, 3> Matrix1x3d;
  typedef Matrix<double, 1, 4> Matrix1x4d;
  typedef Matrix<double, 4, 3> Matrix4x3d;
  typedef Matrix<double, 6, 3> Matrix6x3d;
  typedef Matrix<double, 6, 7> Matrix6x7d;
  typedef Matrix<double, 8, 4> Matrix8x4d;
  typedef Matrix<double, -1, 1, 0, MAX_DOF, 1> VectorJXd;
  typedef Matrix<double, -1, 1, 0, 12, 1> VectorLXd; //Leg IK
  typedef Matrix<double, -1, -1, 0, MAX_DOF, MAX_DOF> MatrixJXd;

  typedef Matrix<double, MODEL_DOF_VIRTUAL, MODEL_DOF_VIRTUAL> MatrixVVd;

  typedef Matrix<double, 12, 1> Vector12d;
  typedef Matrix<double, 6, 1> Vector6d;

  typedef Matrix<double, MODEL_DOF, 1> VectorQd;
  typedef Matrix<double, MODEL_DOF_VIRTUAL, 1> VectorVQd;
  typedef Matrix<double, MODEL_DOF_QVIRTUAL, 1> VectorQVQd;

  typedef Matrix<double, 6, MODEL_DOF_VIRTUAL> Matrix6Vd;
  typedef Matrix<double, 3, MODEL_DOF_VIRTUAL> Matrix3Vd;
  typedef Matrix<double, 6, 12> Matrix6x12d;
  typedef Matrix<double, 6, 8> Matrix6x8d;
  typedef Matrix<double, 6, 3> Matrix6x3d;
  typedef Matrix<double, 3, 12> Matrix3x12d;
  typedef Matrix<double, 3, 8> Matrix3x8d;
  typedef Matrix<double, 3, 3> Matrix3x3d;

  typedef Matrix<double, 6, MODEL_DOF> Matrix6Qd;
  typedef Matrix<double, MODEL_DOF, MODEL_DOF> MatrixQQd;
  typedef Matrix<double, 3, MODEL_DOF> Matrix3Qd;

  typedef Matrix<float, 1, 3> Matrix1x3f;
  typedef Matrix<float, 1, 4> Matrix1x4f;
  typedef Matrix<float, 4, 3> Matrix4x3f;
  typedef Matrix<float, 6, 3> Matrix6x3f;
  typedef Matrix<float, 6, 7> Matrix6x7f;
  typedef Matrix<float, 8, 4> Matrix8x4f;
  typedef Matrix<float, -1, 1, 0, MAX_DOF, 1> VectorJXf;
  typedef Matrix<float, -1, 1, 0, 12, 1> VectorLXf; //Leg IK
  typedef Matrix<float, -1, -1, 0, MAX_DOF, MAX_DOF> MatrixJXf;

  typedef Matrix<float, MODEL_DOF_VIRTUAL, MODEL_DOF_VIRTUAL> MatrixVVf;

  typedef Matrix<float, 12, 1> Vector12f;

  typedef Matrix<float, MODEL_DOF, 1> VectorQf;
  typedef Matrix<float, MODEL_DOF_VIRTUAL, 1> VectorVQf;
  typedef Matrix<float, MODEL_DOF_QVIRTUAL, 1> VectorQVQf;

  typedef Matrix<float, 6, MODEL_DOF_VIRTUAL> Matrix6Vf;
  typedef Matrix<float, 3, MODEL_DOF_VIRTUAL> Matrix3Vf;
  typedef Matrix<float, 6, 12> Matrix6x12f;
  typedef Matrix<float, 6, 8> Matrix6x8f;
  typedef Matrix<float, 6, 3> Matrix6x3f;
  typedef Matrix<float, 3, 12> Matrix3x12f;
  typedef Matrix<float, 3, 8> Matrix3x8f;
  typedef Matrix<float, 3, 3> Matrix3x3f;

  typedef Matrix<float, 6, MODEL_DOF> Matrix6Qf;
  typedef Matrix<float, MODEL_DOF, MODEL_DOF> MatrixQQf;
  typedef Matrix<float, 3, MODEL_DOF> Matrix3Qf;
