...
int main()
{
  ...
  while (true)
  {
    ...
    printf(" cnt1 %10d lat avg %6.3f max %6.3f ovf %d, send avg %6.3f max %6.3f ovf %d\n", (int)shm_msgs_->statusCount,
           shm_msgs_->lat_avg / 1000.0, shm_msgs_->lat_max / 1000.0, shm_msgs_->lat_ovf,
           shm_msgs_->send_avg / 1000.0, shm_msgs_->send_max / 1000.0, shm_msgs_->send_ovf);
    printf(" cnt2 %10d lat avg %6.3f max %6.3f ovf %d, send avg %6.3f max %6.3f ovf %d\n", (int)shm_msgs_->statusCount2,
           shm_msgs_->lat_avg2 / 1000.0, shm_msgs_->lat_max2 / 1000.0, shm_msgs_->lat_ovf2,
           shm_msgs_->send_avg2 / 1000.0, shm_msgs_->send_max2 / 1000.0, shm_msgs_->send_ovf2);
    int i = 0;
