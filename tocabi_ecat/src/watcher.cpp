...
int main()
{
  ...
  while (true)
  {
    ...
    printf("\33[2K\33[2K\33[2K\r  cnt %10d lat avg %6.3f max %6.3f min %6.3f dev %6.4f, send avg %6.3f max %6.3f min %6.3f dev %6.4f\n", (int)shm_msgs_->t_cnt,
    ...
    printf("%3.1f %3.1f %3.1f %3.1f %3.1f %3.1f %3.1f %3.1f ", shm_msgs_->pos[15], shm_msgs_->pos[16], shm_msgs_->pos[17], shm_msgs_->pos[18], shm_msgs_->pos[19], shm_msgs_->pos[20], shm_msgs_->pos[21], shm_msgs_->pos[22]);
    std::fflush(stdout);
